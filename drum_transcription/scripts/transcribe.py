...
from src.data.midi_processing import create_midi_from_onsets, get_gm_drum_mapping, get_drum_names
...
class DrumTranscriber:
    ...
    def __init__(
        ...
        self.gm_mapping = get_gm_drum_mapping()
    ...
    def transcribe(
        ...
        onsets = self.postprocess_predictions(
            ...
            min_interval=min_onset_interval
        )
...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help='Onset detection threshold (0-1)'
    )
    parser.add_argument(
        '--min-interval',
        type=float,
        default=None,
        help='Minimum interval between onsets (seconds)'
    )
    parser.add_argument(
        '--device',
        type=str,
